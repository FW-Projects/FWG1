...
void USART2_IRQHandler(void)
{
    uint8_t chData;
    uint16_t received_data;
    uint16_t status_flag = usart_flag_get(USART2, USART_ROERR_FLAG);
...
void USART3_IRQHandler(void)
{
    uint8_t chData;
    uint16_t received_data;
    uint16_t status_flag = usart_flag_get(USART3, USART_ROERR_FLAG);

    if (status_flag & USART_ROERR_FLAG)
    {
        received_data = usart_data_receive(USART3);
        return;
    }
...
void UART4_IRQHandler(void)
{
    uint8_t chData;
    uint16_t received_data;
    uint16_t status_flag = usart_flag_get(UART4, USART_ROERR_FLAG);

    if (status_flag & USART_ROERR_FLAG)
    {
        received_data = usart_data_receive(UART4);
        return;
    }
...
void UART5_IRQHandler(void)
{
    uint8_t chData;
    uint16_t received_data;
    uint16_t status_flag = usart_flag_get(UART5, USART_ROERR_FLAG);

    if (status_flag & USART_ROERR_FLAG)
    {
        received_data = usart_data_receive(UART5);
        return;
    }
